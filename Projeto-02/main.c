...
int main(void) {
	...
	system("color F");
     ...
     printf("Inserção do nome da Autoridade Máxima\n\n");
     ...
     do {
          ...
          if(tamanho_nom_pres == 1) {
               ...
               printf("Presidente: %s", nome_presidente); 
          }
     ...
     do{  
          ...
          switch(opcao_menu) {
               ...
               case 1:
                    ...
                    do {
                         fflush(stdin);
                         printf("Informe o nome da cidade onde foi realizado o jogo: ");
               ...
               case 3:
                    ...
                    for(contador = 0; contador < i; contador++) {
                         if(cidade_veri == jogos_id[i].cidade) {
                              printf("Id do jogo: %d", jogos_id[contador].id_jogo);
                              printf("Total ganho no jogo: %.2f", jogos_id[contador].valor_total);
                         }
                         else {
